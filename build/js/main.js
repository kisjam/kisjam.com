...
/***/ (function(module, exports, __webpack_require__) {
	...
	var vue_entry = new _vue2.default({
	  el: '#entry',
	  data: {
	  ...
	  created: function created() {
	    ...
	    var arr_categories = [];
	    _axios2.default.get(this.url + 'wp-json/wp/v2/categories/?per_page=30').then(function (response) {
	      ...
	      try {
	        for (var _iterator = _this.categories[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    ...
	    _axios2.default.get(this.url + 'wp-json/wp/v2/posts/?per_page=5').then(function (response) {
	      ...
	      try {
	        for (var _iterator2 = _this.posts[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          ...
	          var date_publish = date_year + '.' + date_month + '.' + date_day;
...
/***/ (function(module, exports) {
	...
	var ParticalNetwork = function () {
	  function ParticalNetwork() {
	    _classCallCheck(this, ParticalNetwork);
	  ...
	  _createClass(ParticalNetwork, [{
	    ...
	    key: 'Ball',
	    value: function Ball(width, height, canvas, ctx) {
	      var _rangeLayer = 4;
	      var _arrVel = [0.05, 0.1, 0.15, 0.2];
	      var _arrSize = [2, 3, 4, 5];
	      var _arrAlpha = [0.3, 0.5, 0.7, 0.9];
	      var _tau = Math.PI * 2;
	    ...
	    value: function _update() {
	      var _diff = Date.now() - this._lasttime;
	    ...
	    value: function _draw() {
	      ...
	      for (var i = 0; i < this._balls.length; i++) {
	        var _ball = this._balls[i];
	        _ball._draw(this._ctx, this._canvas);
	        this._ctx.beginPath();

	        for (var k = this._balls.length - 1; k > i; k--) {
	          var _ball2 = this._balls[k];
	          var _dist = Math.hypot(_ball._x - _ball2._x, _ball._y - _ball2._y);
